...
{
    public static class NewOrderStepB
    {
        [FunctionName("new-order-step-b")]
        public static async Task Run(
            [QueueTrigger("new-order-step-b", Connection = "QueueStorage")]
            RoutingSlip<Order> routingSlip,
            [Queue("new-order-step-b", Connection = "QueueStorage")]
            CloudQueue queue,
            ILogger log)
        {
